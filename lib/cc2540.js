...
CC2540SensorTag.prototype.disableBarometricPressure = function(callback) {
  this.disableConfigCharacteristic(BAROMETRIC_PRESSURE_UUID, BAROMETRIC_PRESSURE_CONFIG_UUID, callback);
};

CC2540SensorTag.prototype.readBarometricPressure = function(callback) {
...
CC2540SensorTag.prototype.onBarometricPressureChange = function(data) {
  this.convertBarometricPressureData(data, function(pressure) {
...
CC2540SensorTag.prototype.notifyBarometricPressure = function(callback) {
...
CC2540SensorTag.prototype.unnotifyBarometricPressure = function(callback) {
...
CC2540SensorTag.prototype.enableGyroscopeAxis = function(enableXAxis, enableYAxis, enableZAxis, callback) {
...
CC2540SensorTag.prototype.buildGyroscopeEnableCode = function(enableXAxis, enableYAxis, enableZAxis) {
  var enableCode = 0;
